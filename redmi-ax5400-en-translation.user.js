...
(function () {
  ...
  const translations = {
    ...
    '根据应用优先级分配网速': 'Allocate network speed based on application priority.',
    '自动模式': 'Automatic mode',
    ...
    '网页优先': 'Web First',
    '优先保证浏览网页的网速，大图秒打开': 'Prioritize the speed of web browsing, and open large pictures in seconds.',
    '视频优先': 'Video Priority',
    ...
    '上传速度': 'Upload speed',
    '下载速度': 'Download speed',
    '输入值太小，最小允许1。': 'The input value is too small. The minimum allowed value is 1.',
    '请填写结束端口。': 'Please fill in the end port.',
    '请填写起始端口。': 'Please fill in the starting port.',
    '新建范围转发规则': 'Create a new range forwarding rule',
    ...
    'DMZ IP地址': 'DMZ IP Address',
    '请填写服务器。': 'Please fill in the server.',
    '请填写用户名。': 'Please fill in your username.',
    '请填写密码。': 'Please enter a password.',
    '请填写主机名称。': 'Please fill in the host name.',
    '小 h': 'Hours',
  };
